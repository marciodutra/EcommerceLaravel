...
<div class="col-12">
    ...
    <form action="<?php echo e(route('cadastrar_cliente')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="row">
       <div class="col-6">
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projetos\ecommerce\eccomerce\resources\views/cadastrar.blade.php ENDPATH**/ ?>